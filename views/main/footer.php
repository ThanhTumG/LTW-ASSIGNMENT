  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>Trụ sở chính</h3>
            <p>
              Tầng 6, Tòa nhà Capital Place,<br>
              Số 29 Liễu Giai, Ngọc Khánh,<br>
              Ba Đình, Hà Nội.<br><br>
              <!-- <strong>Điện thoại:</strong> <br>
              <strong>Email:</strong> .com.vn<br> -->
            </p>
          </div>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <p>Những thông tin và tin tức mới nhất về GARENA sẽ được gửi đến bạn qua email bạn điền dưới đây</p>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>GARENA</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
          Designed by <a href="index.php?page=admin&controller=layouts&action=index">GARENA</a>
        </div>
      </div>
      <div class="social-links text-center text-md-right pt-3 pt-md-0">
        <a href="https://www.facebook.com/GarenaMobileVN" class="facebook"><i class="bx bxl-facebook"></i></a>
