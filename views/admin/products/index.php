                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        <input class="form-control" type="text" placeholder="Tên sản phẩm" name="name" pattern=".{2,100}" title="Tên sản phẩm phải từ 2-100 ký tự" required />
                                                    </div>
                                                    <div class="col-6">
                                                        <label>Giá</label>
                                                        <input class="form-control" type="number" placeholder="Giá" name="price" min="1000" title="Giá phải là số dương" required />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Mô tả</label>
                                                    <textarea class="form-control" name="description" rows="5" pattern=".{10,}" title="Mô tả phải ít nhất 10 ký tự" required></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>Nội dung</label>
                                                    <textarea class="form-control" name="content" rows="10" pattern=".{20,}" title="Nội dung phải ít nhất 20 ký tự" required></textarea>
                                                </div>
                                                <div class="form-group">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form id="form-edit-student" action="index.php?page=admin&controller=products&action=edit" enctype="multipart/form-data" method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="col-12">
                                                        <label>ID</label>
                                                        <input class="form-control" type="text" placeholder="Name" name="id" readonly />
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <label>Tên sản phẩm</label>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="imggg" readonly />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Hình ảnh</label>
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Đóng</button>
                                                    <button class="btn btn-primary formedit" type="submit">Chỉnh sửa</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content bg-danger">
                                            ...
                                            <form action="index.php?page=admin&controller=products&action=delete" method="post">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-danger btn-outline-light" type="button" data-dismiss="modal">Đóng</button>
